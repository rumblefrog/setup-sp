...
function installCompiler(range) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cache = (0, tool_cache_1.find)('amxxpawn', version);
        if (!cache) {
        ...
        (0, core_1.exportVariable)('LD_LIBRARY_PATH', cache);
        return version;
    });
}
...
function downloadCompiler(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let spRoot = (0, path_1.join)(extracted, 'addons', 'amxmodx', 'scripting');
        return yield (0, tool_cache_1.cacheDir)(spRoot, 'amxxpawn', version);
    });
}
